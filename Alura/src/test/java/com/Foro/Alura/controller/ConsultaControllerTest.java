...
import com.Foro.Alura.consulta.DatosDetalleConsulta;
...
class ConsultaControllerTest {
    ...
    //testeando solo el ConsultaController
    @Test
    ...
    void reservar_escenario2() throws Exception {
        ...
        var especialidad = Materia.COMUNICACION;
        ...
        var response = mvc.perform(post("/consultas")
                        ...
                        .content(datosReservaConsultaJson.write(
                                new DatosReservaConsulta(2l, 5l, fecha, materia)
                        ).getJson()))
                .andReturn().getResponse();
